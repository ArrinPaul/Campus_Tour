              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar">
                {filteredBlocks.map((block) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`p-2 rounded-lg ${isActive ? 'bg-emerald-500 text-white' : 'bg-white/5 text-white/40 group-hover:text-white'}`}>
                        <MapPin size={20} />
                      </div>
                      <div className="flex-1 text-left">
                        <div className={`font-medium ${isActive ? 'text-white' : 'text-white/70 group-hover:text-white'}`}>
                      ...
                      <ChevronRight size={16} className={`transition-transform ${isActive ? 'text-emerald-400 rotate-90' : 'text-white/20 group-hover:translate-x-1'}`} />
                    </button>
                  );
                })}
              </div>
