  ...
  return (
    <AnimatePresence>
      {isMapOpen && (
        ...
        >
          <motion.div
            className="relative w-full max-w-2xl bg-zinc-900/95 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden shadow-2xl"
            ...
            <div className="px-6 py-4 border-b border-white/10 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/50">Click a building to teleport</p>
                </div>
              </div>
              <button
                onClick={() => setMapOpen(false)}
