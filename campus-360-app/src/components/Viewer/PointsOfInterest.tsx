    ...
    <group position={[poi.x, poi.y, poi.z]}>
      ...
      <Html center zIndexRange={[100, 0]}>
        <div className="relative">
          <button
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.4)] border-2 ${
              isActive
                ...
                : 'bg-[#0d1829]/90 border-sky-500 text-sky-400 hover:bg-sky-500 hover:text-white hover:border-white'
            }`}
          >
          ...
          {/* Pulse Ring */}
          {!isActive && (
            <div className="absolute inset-0 rounded-full border-2 border-sky-400 animate-ping pointer-events-none opacity-50" />
          )}
          ...
          <AnimatePresence>
            {isActive && (
              <motion.div
                ...
                className="absolute top-16 left-1/2 -translate-x-1/2 w-96 bg-[#0d1829]/95 backdrop-blur-xl border border-sky-500/30 rounded-2xl shadow-2xl overflow-hidden z-50 pointer-events-auto flex flex-col max-h-[70vh]"
              ...
              >
                ...
                <div className="p-6 overflow-y-auto custom-scrollbar">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed mb-5 border-l-2 border-sky-500/50 pl-3">
                    {poi.description}
                  </p>
                      ...
                      {poi.video.includes('youtube.com') || poi.video.includes('youtu.be') ? (
                        ...
                        <div className="flex items-center justify-center h-full bg-[#1a2332]">
                          <a
                            ...
                            className="px-4 py-2 bg-sky-600 hover:bg-sky-500 text-white rounded-lg text-xs font-bold uppercase tracking-wider transition-colors"
                          >
